# [Django DB Backup/Restore](https://docs.appseed.us/technologies/django/backup-restore/)
...
On top of this modern UI Kit, the codebase has been updated to provide a DB BackUP & Restore Mechanism using `django-dbbackup` library. 
...
```bash
$ git clone https://github.com/app-generator/sample-django-backup-restore.git
...
---
[Django DB Backup/Restore](https://docs.appseed.us/technologies/django/backup-restore/) - **Django** Starter provided by **[AppSeed](https://appseed.us/)**
